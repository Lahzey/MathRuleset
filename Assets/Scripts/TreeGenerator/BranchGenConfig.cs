...
public class BranchGenConfig : ScriptableObject {
	...
	[Header("Radius")]
	[SerializeField] private Vector2 radiusRange = new Vector2(1f, 1f);
	public float Radius(Random random) => random.Range(radiusRange.x, radiusRange.y);
	
	[SerializeField] private Vector2 radiusDecayRange = new Vector2(0.4f, 0.4f);
	...
	[SerializeField] private Vector2 nodeFrequencyRange = new Vector2(1f, 2f);
	public float NodeFrequency(Random random) => random.Range(nodeFrequencyRange.x, nodeFrequencyRange.y);
	
	[SerializeField] private Vector2 nodeXAngleRange = new Vector2(-5f, 5f);
	[SerializeField] private Vector2 nodeZAngleRange = new Vector2(-5f, 5f);
	...
	public Vector2 MaxNodeXAngleDeviation = new Vector2(-30f, 30f);
	public Vector2 MaxNodeZAngleDeviation = new Vector2(-30f, 30f);
	
	[Header("Leaf Generation")]
	[SerializeField] private Vector2 leafSpawnRadiusThreshold = new Vector2(0.01f, 0.02f);
	public float LeafSpawnRadiusThreshold(Random random) => random.Range(leafSpawnRadiusThreshold.x, leafSpawnRadiusThreshold.y);
	
	[SerializeField] private Vector2 minLeafSize = new Vector2(0.2f, 0.2f);
	[SerializeField] private Vector2 maxLeafSize = new Vector2(0.3f, 0.3f);
